...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Referencelinecoin-seeder\n"
...
static const string mainnet_seeds[] = {"dnsseed.referencecoin.co", ""};
static const string testnet_seeds[] = {""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 4733), true);
  }
  do {
